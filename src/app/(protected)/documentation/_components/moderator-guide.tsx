    ...
    actions: [
      {
        ...
        reminders: [
          "Speakers often mix the order of past and future—prompt gently if the flow drifts.",
        ],
        callouts: [
...
First, reflect on the past 3 months in the order of work, family, personal life. Then speak about the next 3 months in the same order. If you aren't sure, please see the image at the bottom right of page 29 in the Goen Net Guide.”`,
      },
      {
        ...
        procedure:
          "Appoint two members to take notes (split the roster if needed) and clarify exactly what to capture.",
        reminders: [
        ...
        callouts: [
          "★ Point secretaries to section 2 of the Guide and the table on page 30 so they know what the log should look like.",
        ],
...
Please read section 2, Update, in the Guide. Use the table on page 30 to list only the problems or challenges you hear. These become candidates for presentations, so you don’t need to record happy matters or expectations.”`,
      },
      {
        ...
        procedure:
          "Remind everyone to listen for issues worth discussing and to stay inside the communication protocol.",
        script:
          "“We will have discussion to prioritize issues after the updates. Please focus on the presenter’s nonverbal expressions and emotions, not just the words. Make mental notes about whose issue sounded significant or which one you hope we resolve. Look at the speaker as much as you can. Who would like to go first? Let’s go clockwise from that person.”",
      },
      {
        title: "0:07 Hand a timer to the first speaker",
        script:
          "“So, Ms. XX, would you please start? Here is the timer—please finish within 5 minutes.”",
      },
      {
        title: "During each share keep clarifying questions brief",
        procedure:
          "Allow one question per person (one to two minutes total) before moving on. Defer deeper discussion to prioritization.",
        reminders: [
        ...
        script:
          "“Thank you. Are there any questions? If not, no problem. Time is limited, so let’s keep it to one question per person and a total of one to two minutes. There will be time when we prioritize the issues, so we can ask more questions then.”",
      },
      {
        title: "0:53 Thank the secretaries and close the round",
        script:
          "“This is the end of the updates. I would like to thank the secretary, Mr. XX, for all your hard work.”",
      },
    ],
  },
  {
...
When choosing whose issue to resolve, pay attention to moments of strong emotion, the speaker's expression, or tone of voice. Finally, consider the importance and urgency of the issue. If you are unsure, please refer to section 3, Prioritize Issues, in the Guide.”`,
      ...
      },
      {
        ...
        script:
          "“I would like to assign two people to serve as coaches, and since it would be better if the coaches and presenters shared similar awareness, what about you, Mr. XX? Thank you.”",
      },
      {
    ...
    actions: [
      {
        ...
        callouts: [
          "★ Remind everyone that unanswered questions can be clarified during the Q&A after the presentation.",
        ],
        script:
          "“We’ll take about 20 minutes for coaching. Presenters and coaches, use this time to clarify the issue and prepare the communication starter. Everyone else, feel free to stretch, refresh, and think about how you can support. Please be back by [time].”",
      },
      {
        ...
        script:
          "“If anything feels unclear, let’s review the presentation method together. We want you to feel ready to share the title of the issue, expectations, confidentiality level, and the communication starter before the presenter speaks.”",
      },
    ],
  },
  {
    ...
    actions: [
      ...
      },
      {
        ...
        callouts: [
          "★ The process observer tracks protocol adherence and highlights strong questions as well as missed opportunities.",
        ],
      ...
      },
      {
        ...
        reminders: [
          "Verify that the communication starter invites everyone to look at the presenter and signal they are ready to listen.",
        ],
        script:
          "“Now, shall we start from the coach? Please speak in line with the order on your worksheet.”",
      },
      {
        title: "1:38 Presenter shares the issue (10 min)",
        procedure:
          "Encourage attentive listening and remind members they can take brief notes while staying visually engaged.",
        script:
          "“Before we begin the presentation, you can take notes while you listen—and make sure that you pay full attention to the presenter. Let’s not keep looking at the notes; look at the presenter as much as you can. Are we ready? Please speak in order from the top of the worksheet.”",
      },
      {
        ...
        script:
          "“Thank you. Now, if there is something you would like to ask or confirm regarding the presenter’s issue, please go ahead—keeping the communication protocol in mind.”",
      },
      {
        ...
        script:
          "“Now, let’s share lessons learned from relevant or similar experiences for the presenter. I will hand a timer to the first speaker. Please keep it to 3 minutes per person. Later, I want you to make a personal note as a gift to the presenter.”",
      },
      {
        title: "2:28 Invite the presenter’s reflection (5 min)",
        script:
          "“It is now the presenter’s turn to give feedback about what you felt and what your takeaway is. If there is nothing, that’s fine. If you can’t tell yet, that’s fine too. Be very honest.”",
      },
      {
        title: "2:30 Capture process feedback and hand over personal notes",
        reminders: [
          "Add moderator feedback if you noticed protocol drift or dynamics that need attention.",
        ],
    ...
    actions: [
      {
        ...
        procedure:
          "Collect all notes, shred or dispose of them, and remind members to keep the discussion private.",
        script:
          "“It is time to close the session. To ensure confidentiality, let’s destroy all notes that you took today. After leaving this room, please maintain confidentiality about everything we talked about here.”",
      },
      {
        title: "3:35 Confirm the schedule for next time",
        procedure:
          "Agree on the next session’s date and decide who will coordinate if the proposed time does not work.",
        script:
          "“Next, let’s confirm the schedule for next time and decide the date for the meeting after that. The next scheduled date is MM/DD from [time]. Will this work with your schedules?”",
      },
      {
        ...
        procedure:
          "Invite any final feedback on how the session ran and what to improve next time.",
      },
      {
        title: "3:39 Close with “How do you feel now?”",
        procedure:
          "Do a final feelings round—about one minute per person—to help members leave grounded.",
        script:
          "“As a closing exercise to organize our thoughts, I want everyone to speak openly for about one minute about how you feel now. The session ends when everyone has shared.”",
      },
    ],
  },
];
...
const singlePresentationSections: Section[] = [
  ...twoPresentationSections
    .slice(0, 5)
    .map((section) => cloneSection(section, { stripActionTimes: true })),
  cloneSection(
    {
...
const schedules: Record<Scenario, Section[]> = {
  twoPresentations: twoPresentationSections.map((section) =>
    cloneSection(section, { stripActionTimes: true })
  ),
  singlePresentation: singlePresentationSections,
};

export function ModeratorGuide() {
      ...
      <Container maxWidth="md" sx={{ py: { xs: 4, md: 6 }, pb: { xs: 16, md: 16 } }}>
        <Stack spacing={4}>
          ...
          >
            ...
            <Typography
              variant="body2"
              sx={{ color: "rgba(255, 255, 255, 0.7)", display: "flex", alignItems: "center" }}
            >
          ...
          <Fade in={true} key={activeStep}>
            <Box>
              ...
              {activeSlide.actionIndex === activeSlide.totalActionsInSection - 1 &&
                activeSlide.section.afterNote && (
                  <Box sx={{ mt: 3 }}>
      ...
      >
        <Container maxWidth="md">
          <Stack direction="row" justifyContent="space-between" alignItems="center">
            ...
            >
              {activeSlide.section.title} ({activeSlide.actionIndex + 1}/
              {activeSlide.totalActionsInSection})
            </Typography>
  ...
  return (
    ...
    >
      <Stack spacing={2}>
        ...
        {section.purpose && section.purpose.length > 0 && (
  ...
  return (
    ...
    >
      <Stack spacing={3}>
        <Typography
          variant="h5"
          sx={{ fontWeight: 800, color: "primary.main", fontSize: { xs: "1.35rem", md: "1.6rem" } }}
        >
          {action.title}
        </Typography>
        {action.procedure ? (
          <Typography sx={{ fontSize: "1.1rem", lineHeight: 1.6, color: "text.primary" }}>
            {action.procedure}
          </Typography>
        ) : null}
        {action.steps ? (
      ...
      <Stack component="ul" spacing={1} sx={{ pl: 2.5, m: 0 }}>
        {items.map((item) => (
          <Typography
            component="li"
            key={item}
            sx={{ color: "warning.900", fontWeight: 500, fontSize: "1.05rem" }}
          >
            {item}
          </Typography>
        ))}
...
function CalloutBox({ items }: CalloutBoxProps) {
  ...
  return (
    ...
    >
      <Typography
        variant="subtitle2"
        sx={{ fontWeight: 800, color: "info.800", mb: 1, letterSpacing: "0.05em" }}
      >
        ★ Key Talking Points
      </Typography>
      <Stack component="ul" spacing={1} sx={{ pl: 2.5, m: 0 }}>
        {items.map((item) => (
          <Typography
            component="li"
            key={item}
            sx={{ color: "info.900", fontWeight: 500, fontSize: "1.05rem" }}
          >
            {item}
          </Typography>
        ))}

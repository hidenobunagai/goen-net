...
function normalizeFormValue(value: unknown): PresenterForm {
  ...
  return {
    ...
    typeHome: parsed.typeHome ?? (legacyType.includes("home") || legacyType.includes("family")),
    typePersonal:
      parsed.typePersonal ?? (legacyType.includes("personal") || legacyType.includes("self")),
  };
}
    ...
    () => [
      {
        ...
        description: "Capture the context, emotions, and expectations around the issue.",
      },
      {
        title: "Co-create insight",
        description: "Partner with your coach to surface perspectives and options.",
      },
      {
        title: "Plan your ask",
        description: "Shape a clear request that invites support from your peers.",
      },
    ],
    []
  );
            ...
            <Stack spacing={3}>
              ...
              <Stack spacing={2}>
                <Typography color="text.secondary" sx={{ fontSize: 14, maxWidth: 760 }}>
                  First, fill in the boxes below. Then let the coach ask you to clarify the issue
                  you are facing, so that you can describe specifically about (a) what is happening
                  in what context, (b) what you feel about it, (c) what you think will/might happen,
                  and (d) your options. After sorting out the situation and identifying your issue,
                  the presenter and the coach together prepare communication starters.
                </Typography>
          ...
          <Paper
            ...
            `,
              ...
              "&::before": {
                ...
                padding: "1px",
                background:
                  "linear-gradient(135deg, rgba(0, 51, 102, 0.1), rgba(230, 0, 18, 0.08), rgba(0, 51, 102, 0.04))",
          ...
          >
            <Stack spacing={2.5}>
              ...
              <Box sx={{ px: 0.5 }}>
                ...
                <Typography variant="body2" color="text.secondary" sx={{ mb: 1 }}>
                  What are your likely options? What do you really want to do about the issue at
                  hand?
                </Typography>
                <TextField
                  fullWidth
          ...
          >
            <Stack spacing={2.5}>
              ...
              <Box sx={{ px: 0.5 }}>
                ...
                <Typography variant="body2" color="text.secondary" sx={{ mb: 1 }}>
                  Share experience and lesson learned, emotional support, ideas, opinions,
